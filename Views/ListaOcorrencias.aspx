<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListaOcorrencias.aspx.cs" MasterPageFile="~/Views/Website.Master" Inherits="VistoriasProjeto.Views.ListaOcorrencias" %>

<asp:Content ID="ListaOcorrencias" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
    ...
    <div>
        ...
        <div>
            <asp:GridView ID="dgvOcorrencia" class="gridview" OnRowCommand="dgvOcorrencia_RowCommand" runat="server">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
